...
idp:
  ...
  password_forgotten_url: "https://nauthilus.example.com/forgot-password"
...
lua:
  ...
  config:
    ...
    cache_flush_script_path: ./server/lua-plugins.d/hooks/cache_flush.lua  # Optional, used by DELETE /api/v1/cache/flush*
