...
| idp         | Communication within the native Identity Provider                                      |
...
| cookie       | Turn on debugging for cookie-related operations                                        |
...
_Default: ["en", "de", "fr", "es", "it", "pt", "ru", "zh", "hi", "fa", "ar", "ja"]_
...
| Key       | Description |
|-----------|-------------|
| oidc_cid  | Header name that will carry the OIDC Client ID for observability, logging and Lua filters |
