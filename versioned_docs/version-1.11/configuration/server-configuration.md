...
Notes:
- `endpoint` is the collector host and port only (no scheme, no path). Path defaults to `/v1/traces`; scheme is chosen by TLS settings.

See also: Guides → Tracing (OpenTelemetry): /docs/1.11/guides/tracing-opentelemetry
