...
| brute\_force                | Enable brute force protection features                                                                    |

#### server::features::when\_no\_auth
_Default: false_
...
#### server::frontend::html\_static\_content\_path
_Default: "/usr/app/static"_

Define the path where Nauthilus will find OAuth2 pages and content.

#### server::frontend::default\_logo\_image
_Default: "/static/img/logo.png"_

Path to the company logo. The path is the location part of an HTTP url.

#### server::frontend::login\_page
_Default: "/login"_

This is the URI path for the login page.

#### server::frontend::login\_page\_welcome
_Default: ""_

If you define this string, a headline will appear on top of the company logo on the login page.

#### server::frontend::login\_page\_logo\_image\_alt
_Default: "Logo (c) by Roessner-Network-Solutions"_

The HTML image alt text for the company logo on the login page.

#### server::frontend::two\_factor\_page
_Default: "/register"_

This is the URL path where a user can register a second factor for authentication.

#### server::frontend::consent\_page
_Default: "/consent"_

This is the URI path for the consent page.

#### server::frontend::logout\_page
_Default: "/logout"_

This is the URI path for the logout page.

#### server::frontend::error\_page
_Default: "/error"_

This is the URI path for the error page.

#### server::frontend::notify\_page
_Default: "/notify"_

This is an endpoint for user information returned by Nauthilus.

#### server::frontend::device\_page
_Default: "/device"_

This is the URI path for the device page.

#### server::frontend::homepage
_Default: "https://nauthilus.org"_
...
#### server::frontend::logout\_page\_welcome
_Default: ""_

If you define this string, a headline will appear on top of the company logo on the logout page.

#### server::frontend::consent\_page\_welcome
_Default: ""_

If you define this string, a headline will appear on top of the company logo on the consent page.

#### server::frontend::consent\_page\_logo\_image\_alt
_Default: "Logo (c) by Roessner-Network-Solutions"_

The HTML image alt text for the company logo on the consent page.

#### server::frontend::notify\_page\_welcome
_Default: ""_

If you define this string, a headline will appear on top of the company logo on the notify page.

#### server::frontend::notify\_page\_logo\_image\_alt
_Default: "Logo (c) by Roessner-Network-Solutions"_

The HTML image alt text for the company logo on the notify page.

#### server::frontend::language\_resources
_Default: "/usr/app/resources"_

Specify the absolute path to the language resources. This directory contains the localized files need for Nauthilus.

#### server::frontend::default\_language
_Default: "en"_

The default language used for the frontend.

#### server::frontend::hydra\_admin\_uri
_Default: "http://127.0.0.1:4445"_

This is the protected URI to the Ory Hydra admin endpoint.

#### server::frontend::totp\_issuer
_Default: "nauthilus.me"_

This field is used in the **otpauth://** URL parameter, when restoring a secret key.

#### server::frontend::totp\_skew
_Default: 1_

When using TOTP secrets, this variable is used to allow the server adding **totp_skew** times 30 seconds periods before and after the current time slot.

#### server::frontend::login\_remember\_for
_Default: 10800_
